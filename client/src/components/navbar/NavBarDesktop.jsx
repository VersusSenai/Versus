...
const NavBarDesktop = ({
  ...
  return (
    ...
    >
      ...
      <div
        className="absolute bottom-0 left-0 w-24 h-24 bg-gradient-to-tr from-[var(--color-1)]/10 to-transparent rounded-full blur-xl animate-pulse"
        style={{ animationDelay: '1s' }}
      />

      <div className="relative z-10 p-6 h-full flex flex-col">
        <div
          className={`${collapsed ? 'flex flex-col gap-3 items-center mb-4' : 'flex items-center justify-between mb-6'}`}
        >
        ...
        {!collapsed && (
          <div className="flex justify-center items-center mb-8">
            ...
            >
              <img src={logo} alt="Logo Versus" className="h-32 w-32 drop-shadow-2xl" />
            </motion.div>
          </div>
        )}
                  ...
                  >
                    ...
                    <div
                      className={`flex-shrink-0 transition-all duration-300 ${
                        isActive
                          ? 'text-white'
                          : 'text-[var(--color-2)] group-hover:text-white group-hover:scale-110'
                      }`}
                    >
                      {link.icon}
                    </div>
          ...
          {!collapsed ? (
              ...
              <div className="relative z-10 p-5">
                <div className="flex items-center gap-4 mb-4">
                  <div className="relative group">
                    <div className="w-14 h-14 rounded-2xl overflow-hidden bg-gradient-to-br from-[var(--color-1)] to-[var(--color-2)] flex items-center justify-center shadow-xl shadow-[var(--color-2)]/25 group-hover:shadow-[var(--color-2)]/40 transition-all duration-300">
                      {user?.icon ? (
                        <img
                          src={user.icon}
                          alt="User Avatar"
                          ...
                          onError={(e) => {
                            ...
                            parent.innerHTML =
                              '<svg class="text-white" width="28" height="28" fill="currentColor" viewBox="0 0 20 20"><path fill-rule="evenodd" d="M10 9a3 3 0 100-6 3 3 0 000 6zm-7 9a7 7 0 1114 0H3z" clip-rule="evenodd"/></svg>';
                          }}
                        />
                      ) : (
            ...
            <div className="flex flex-col items-center space-y-4">
              <motion.button
                ...
                title="Minha Conta"
              >
                <div className="w-12 h-12 rounded-2xl overflow-hidden bg-gradient-to-br from-[var(--color-1)] to-[var(--color-2)] flex items-center justify-center shadow-xl shadow-[var(--color-2)]/25 group-hover:shadow-[var(--color-2)]/40 transition-all duration-300">
                  {user?.icon ? (
                    <img
                      src={user.icon}
                      alt="User Avatar"
                      ...
                      onError={(e) => {
                        ...
                        const parent = e.target.parentElement;
                        parent.innerHTML =
                          '<svg class="text-white" width="24" height="24" fill="currentColor" viewBox="0 0 20 20"><path fill-rule="evenodd" d="M10 9a3 3 0 100-6 3 3 0 000 6zm-7 9a7 7 0 1114 0H3z" clip-rule="evenodd"/></svg>';
                      }}
                    />
                  ) : (
